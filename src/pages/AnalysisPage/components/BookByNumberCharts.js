...
import {Panel,Collapse,Body,Button} from 'react-bootstrap';

import ButtonModal from '../../../components/Buttons/ButtonModal';

class BookByNumberCharts extends Component{
    constructor(props){
        super(props);
        this.state = {
            show: true,
    ...
    getPieData(array){
        let rec = [];
        array.forEach(function(item){
            rec.push({value:item.BorrowNumber,name:item.BookName});
        })
        return rec;
    }
    getTitle(array){
...
BookByNumberCharts.PropTypes = {
    Inf: PropTypes.array,
}

export default BookByNumberCharts;